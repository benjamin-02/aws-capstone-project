...
DATABASES = {
    'default': {
        ...
        'USER': 'admin', # database master username
        'PASSWORD': config('PASSWORD'),
        'HOST': 'aws-capstone-rds.cfpgrqy7e7en.us-east-1.rds.amazonaws.com',  # database endpoint
...
AWS_STORAGE_BUCKET_NAME = 'bensblog-aws-capstone' # please enter your s3 bucket name
